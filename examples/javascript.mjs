// CUTAD FreeReels API — JavaScript (Node 18+) contoh semua 5 action
//
// Usage:
...
const BASE = "https://www.cutad.web.id/api/public/freereels";
...
async function main() {
  console.log("=========================================");
  console.log(" CUTAD FreeReels (freereels) — JS demo");
  console.log("=========================================\n");
